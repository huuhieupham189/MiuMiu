...
//
// Table class for cthd
//
class crcthd extends crTableBase {
	...
	function __construct() {
		...
		// MaHD
		$this->MaHD = new crField('cthd', 'cthd', 'x_MaHD', 'MaHD', '`MaHD`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// MaSP
		$this->MaSP = new crField('cthd', 'cthd', 'x_MaSP', 'MaSP', '`MaSP`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// SoLuong
		$this->SoLuong = new crField('cthd', 'cthd', 'x_SoLuong', 'SoLuong', '`SoLuong`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// ThanhTien
		$this->ThanhTien = new crField('cthd', 'cthd', 'x_ThanhTien', 'ThanhTien', '`ThanhTien`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cthd`";
	}
