...
//		$item->Visible = TRUE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[15] = $this->GhiChu->CurrentValue;
		} else {
	...
	function SetupFieldCount() {
		...
		if ($this->GhiChu->Visible) $this->DtlColumnCount += 1;
	}
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="TenLoaiTK"><div class="ThF4ng_Tin_TE0i_Kho1EA3n_TenLoaiTK"><span class="ewTableHeaderCaption"><?php echo $Page->TenLoaiTK->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="TenLoaiTK">
<?php if ($Page->SortUrl($Page->TenLoaiTK) == "") { ?>
		<div class="ewTableHeaderBtn ThF4ng_Tin_TE0i_Kho1EA3n_TenLoaiTK">
			<span class="ewTableHeaderCaption"><?php echo $Page->TenLoaiTK->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer ThF4ng_Tin_TE0i_Kho1EA3n_TenLoaiTK" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->TenLoaiTK) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->TenLoaiTK->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ChietKhau"><div class="ThF4ng_Tin_TE0i_Kho1EA3n_ChietKhau"><span class="ewTableHeaderCaption"><?php echo $Page->ChietKhau->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ChietKhau">
<?php if ($Page->SortUrl($Page->ChietKhau) == "") { ?>
		<div class="ewTableHeaderBtn ThF4ng_Tin_TE0i_Kho1EA3n_ChietKhau">
			<span class="ewTableHeaderCaption"><?php echo $Page->ChietKhau->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer ThF4ng_Tin_TE0i_Kho1EA3n_ChietKhau" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ChietKhau) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ChietKhau->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="DiemChuan"><div class="ThF4ng_Tin_TE0i_Kho1EA3n_DiemChuan"><span class="ewTableHeaderCaption"><?php echo $Page->DiemChuan->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="DiemChuan">
<?php if ($Page->SortUrl($Page->DiemChuan) == "") { ?>
		<div class="ewTableHeaderBtn ThF4ng_Tin_TE0i_Kho1EA3n_DiemChuan">
			<span class="ewTableHeaderCaption"><?php echo $Page->DiemChuan->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer ThF4ng_Tin_TE0i_Kho1EA3n_DiemChuan" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->DiemChuan) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->DiemChuan->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="GhiChu"><div class="ThF4ng_Tin_TE0i_Kho1EA3n_GhiChu"><span class="ewTableHeaderCaption"><?php echo $Page->GhiChu->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="GhiChu">
<?php if ($Page->SortUrl($Page->GhiChu) == "") { ?>
		<div class="ewTableHeaderBtn ThF4ng_Tin_TE0i_Kho1EA3n_GhiChu">
			<span class="ewTableHeaderCaption"><?php echo $Page->GhiChu->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer ThF4ng_Tin_TE0i_Kho1EA3n_GhiChu" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->GhiChu) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->GhiChu->FldCaption() ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_ThF4ng_Tin_TE0i_Kho1EA3n_TenLoaiTK"<?php echo $Page->TenLoaiTK->ViewAttributes() ?>><?php echo $Page->TenLoaiTK->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->ChietKhau->Visible) { ?>
		<td data-field="ChietKhau"<?php echo $Page->ChietKhau->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_ThF4ng_Tin_TE0i_Kho1EA3n_ChietKhau"<?php echo $Page->ChietKhau->ViewAttributes() ?>><?php echo $Page->ChietKhau->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->DiemChuan->Visible) { ?>
		<td data-field="DiemChuan"<?php echo $Page->DiemChuan->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_ThF4ng_Tin_TE0i_Kho1EA3n_DiemChuan"<?php echo $Page->DiemChuan->ViewAttributes() ?>><?php echo $Page->DiemChuan->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->GhiChu->Visible) { ?>
		<td data-field="GhiChu"<?php echo $Page->GhiChu->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->RecCount ?>_ThF4ng_Tin_TE0i_Kho1EA3n_GhiChu"<?php echo $Page->GhiChu->ViewAttributes() ?>><?php echo $Page->GhiChu->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
