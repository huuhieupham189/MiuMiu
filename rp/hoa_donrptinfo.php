...
//
// Table class for hoa_don
//
class crhoa_don extends crTableBase {
	...
	function __construct() {
		...
		// MaHD
		$this->MaHD = new crField('hoa_don', 'hoa_don', 'x_MaHD', 'MaHD', '`MaHD`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		$this->MaHD->DrillDownUrl = "chi_tiet_hoa_donrpt.php?d=1&t=chi_tiet_hoa_don&s=hoa_don&MaHD=f0";

		// TenTT
		$this->TenTT = new crField('hoa_don', 'hoa_don', 'x_TenTT', 'TenTT', '`TenTT`', 200, EWR_DATATYPE_STRING, -1);
		...
		// TenVC
		$this->TenVC = new crField('hoa_don', 'hoa_don', 'x_TenVC', 'TenVC', '`TenVC`', 200, EWR_DATATYPE_STRING, -1);
		...
		// NgayLap
		$this->NgayLap = new crField('hoa_don', 'hoa_don', 'x_NgayLap', 'NgayLap', '`NgayLap`', 133, EWR_DATATYPE_DATE, 0);
		...
		// TongTien
		$this->TongTien = new crField('hoa_don', 'hoa_don', 'x_TongTien', 'TongTien', '`TongTien`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// TinhTrang
		$this->TinhTrang = new crField('hoa_don', 'hoa_don', 'x_TinhTrang', 'TinhTrang', '`TinhTrang`', 200, EWR_DATATYPE_STRING, -1);
		...
		// MaTK
		$this->MaTK = new crField('hoa_don', 'hoa_don', 'x_MaTK', 'MaTK', '`MaTK`', 3, EWR_DATATYPE_NUMBER, -1);
