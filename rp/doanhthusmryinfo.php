...
//
// Table class for doanhthu
//
class crdoanhthu extends crTableBase {
	...
	function __construct() {
		...
		// MaHD
		$this->MaHD = new crField('doanhthu', 'doanhthu', 'x_MaHD', 'MaHD', '`MaHD`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// NgayLap
		$this->NgayLap = new crField('doanhthu', 'doanhthu', 'x_NgayLap', 'NgayLap', '`NgayLap`', 133, EWR_DATATYPE_DATE, 0);
		...
		// TongTien
		$this->TongTien = new crField('doanhthu', 'doanhthu', 'x_TongTien', 'TongTien', '`TongTien`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// TinhTrang
		$this->TinhTrang = new crField('doanhthu', 'doanhthu', 'x_TinhTrang', 'TinhTrang', '`TinhTrang`', 200, EWR_DATATYPE_STRING, -1);
		...
		// TenTT
		$this->TenTT = new crField('doanhthu', 'doanhthu', 'x_TenTT', 'TenTT', '`TenTT`', 200, EWR_DATATYPE_STRING, -1);
		...
		// TenVC
		$this->TenVC = new crField('doanhthu', 'doanhthu', 'x_TenVC', 'TenVC', '`TenVC`', 200, EWR_DATATYPE_STRING, -1);
		...
		// MaTK
		$this->MaTK = new crField('doanhthu', 'doanhthu', 'x_MaTK', 'MaTK', '`MaTK`', 3, EWR_DATATYPE_NUMBER, -1);
