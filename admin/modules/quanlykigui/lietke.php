...
where loaisp.maloaisp=sanpham.maloaisp and thuonghieu.mathuonghieu=sanpham.mathuonghieu and loaisp.maloaisp=13
...
<table  border="1">
  ...
  <tr>
    ...
    <td><a href="index.php?quanly=kigui&ac=thongtinct&id=<?php echo $dong['MaSP'] ?>" ><center><img src="imgs/edit.png" width="30" height="30" /></center></a></td>
    <td><a href="modules/quanlykigui/xuli.php?id=<?php echo $dong['MaSP']?>" class="delete_link"><center><img src="imgs/delete.png" width="30" height="30"   /></center></a></td>
  </tr>
  <?php
  $i++;
  }
...
<div class="trang">
	Trang :
    <?php
	$sql_trang=$conn->query("select * from sanpham where maloaisp=13");
