...
infosoftglobal.FusionCharts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	if (window.YAHOO) this.autoInstallRedirect = this.autoInstallRedirect && !YAHOO.env.ua.ios; // ***
...
// Modified by e.World to support both FusionCharts and FusionChartsFree
//***var FusionCharts = infosoftglobal.FusionCharts;
var FusionChartsFree = infosoftglobal.FusionCharts; // ***