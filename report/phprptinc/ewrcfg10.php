...
define("EWR_PROJECT_ID", "{51aa5d8b-b6cb-4649-8aa4-db7e733e77ad}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "banhangonline", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'XuhzVRGPvJ5khtu5', TRUE); // Random key for encryption
